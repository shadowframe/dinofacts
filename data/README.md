...
## Datenintegrität
Um die Integrität der Daten zu gewährleisten, wurde ein Test geschrieben, der sicherstellt, dass die Daten in der `dino.json` Datei umfänglich vorhanden sind. Dies wird durch die Datei `tests/test_data_integrity.py` überprüft. Der Test prüft, ob alle IDs in der JSON-Datei aufsteigend und lückenlos sind.
